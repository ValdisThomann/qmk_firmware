 ...
 *           `--------------------------------------------------------------------'
 */
  [_FL] = LAYOUT_hhkb_splits(
       KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_DEL,
       KC_CLCK, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   _______, KC_DEL,
...
*            `--------------------------------------------------------------------'
*/
  [_SL] = LAYOUT_hhkb_splits(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS, TG(_CL),
      KC_CLCK, _______, _______, _______, _______, _______, KC_PGUP, _______, KC_UP,   _______, KC_PGDN, _______, _______, KC_DEL,
      _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  _______, _______,
 ...
 */
  [_CL] = LAYOUT_hhkb_splits(
      ...
      KC_CLCK, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______,  _______,          _______, _______,
